...
useEffect(() => {
    ...
    return (
            ...
            <CustomText style={[styles.sectionTitle, styles.additionalStyle]}>Last Collected Assets</CustomText>
            {lastAssets.length === 0 ? (
            <CustomText style={styles.noAssetsText}>you have no assets</CustomText>  // Fallback message if no assets
            ) : (
            ...
            {moreAssets.length > 0 && (
                <>
                    ...
                    <ScrollView horizontal contentContainerStyle={styles.assetsContainer}>
                        {moreAssets.slice(0, 5).map((asset) => (
                            <TouchableOpacity key={asset.name} onPress={() => handleSelectAsset(asset)} style={styles.imageContainer}>
                                <Image source={{ uri: asset.url }} style={styles.image} />
                                {asset.url.includes('$') && (
                                    <View style={styles.vipIconContainer}>
                    ...
                    <ScrollView horizontal contentContainerStyle={styles.assetsContainer}>
                        {moreAssets.slice(5, 10).map((asset) => (
                            <TouchableOpacity key={asset.name} onPress={() => handleSelectAsset(asset)} style={styles.imageContainer}>
                                <Image source={{ uri: asset.url }} style={styles.image} />
                                {asset.url.includes('$') && (
                                    <View style={styles.vipIconContainer}>
